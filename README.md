...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/matheus-2106/robo-peex-ufopa.git
   ```

2. Instale o OpenSCAD:

   ```bash
   apt-get install openscad
   ```
     ou baixe o pacote diretamente do site oficial: [OpenSCAD.org/downloads](https://openscad.org/downloads.html)
...
1. Renderize o modelo em _Design > Render_ ou simplesmente aperte _F6_
...
Matheus Linhares - [@Matheus-2106](https://github.com/Matheus-2106) - matheus.linhares.2106@gmail.com

Link do Projeto: [https://github.com/matheus-2106/robo-peex-ufopa](https://github.com/Matheus-2106/robo-peex-ufopa)
